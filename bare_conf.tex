...
\begin{figure}
	...
	\textwidth] {pics/samebranching.png} \caption{Same-branching dependency direction} 
\label{fig:samebranching} \end{figure}

\begin{figure}
	\centering \includegraphics[width=0.5
	\textwidth] {pics/mixedbranching.png} \caption{Mixed-branching dependency direction} 
